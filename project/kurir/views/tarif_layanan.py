...
class KurirTarifLayananView(View):
	def get(self, request):
		...
		for data in tarif_layanan:
			data_list = [data['id_tarif_layanan']]
		...
		return render(request, 'mobile_kurir/templates/tarif_layanan/index.html', context={'tarif_layanan': data_tarif_layanan, 'is_active_tarif':'active'})